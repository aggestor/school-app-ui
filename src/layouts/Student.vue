...
<script setup>
    import SideBar from '../components/v2/student/SideBar.vue';
    import Navbar from '../components/v2/student/Navbar.vue';
    import {ref} from "vue"
    ...
    if(user && token && type && type.toLocaleLowerCase() == 'student'){

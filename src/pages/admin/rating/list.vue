<template>
    <div class="w-[95%] mt-2 mx-auto">
        <div class="flex border-b mb-3 py-2 items-center justify-between">
           ...
           <div class="flex items-center">
            <span class="w-7 h-7 mr-2 rounded bg-gray-200 grid place-items-center">{{ ratings?.length}}</span>
        ...
        <div class="border-b pb-1  font-semibold flex items-center justify-between">
            ...
            <span class="w-3/12 flex justify-center">ratings</span>
        ...
        <div v-for="o of ratings" :class="` py-2 text-sm  flex items-center justify-between ${ratings.indexOf(o) % 2 != 0 ? 'bg-gray-100' :''}`">

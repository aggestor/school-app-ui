    ...
    <div class="mt-6">
        <div class="w-full md:h-full  flex justify-center items-center">
            <div v-if="!promptSuccessBox" class="md:w-5/12 border w-11/12 md:mb-5 mb-3 mt-10  bg-white __shad  shadow-gray-200 flex h-auto rounded p-8  justify-center flex-col" >
                <PagesNavigationHeader title="Ajouter un carrousel"/>
...
export default {
    ...
    methods: {
        ...
        async onPressCreate() {
            const result = await Slider.create({name:this.name, duration:this.duration,shop:this.shopId, youtube:this.youtube, image:this.fileImage, date:this.date})
